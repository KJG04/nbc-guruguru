...
public class ScoreManage {
    public Map<Integer, Score> scoreMap = new HashMap<>();

    public void addScore(Score score){
        if(!scoreMap.containsKey(score.hashCode())) scoreMap.put(score.hashCode(), score);
    ...
    public void replaceScore(Score score) {
        ...
        if(scoreMap.containsKey(score.hashCode())){
            scoreMap.put(score.hashCode(), score);
        }
    }
